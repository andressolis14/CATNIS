...
<head>
    ...
    <!-- Google Fonts -->
    <link
        href="https://fonts.googleapis.com/css2?family=Fredoka:wght@400;500;600;700&family=Inter:wght@400;600&display=swap"
        rel="stylesheet">
    <!-- Bootstrap 5 -->
            ...
            <?php foreach ($productos as $p): ?>
                <?php if ($p['activo']):
                    ...
                    if (!empty($p['imagen'])) {
                        ...
                        if (stripos($p['nombre'], 'croissant') !== false)
                            $img = APP_URL . '/img/bread.png';
                    }
                    ?>
                        ...
                        <div class="product-card">
                            ...
                            <div class="p-content">
                                ...
                                <div class="p-footer">
                                    ...
                                    <?php if ($p['stock'] > 0): ?>
                                        <button class="btn-wa-add"
                                            onclick="pedir('<?= htmlspecialchars($p['nombre']) ?>', '<?= $img ?>')">
